            ...
            <Navbar collapseOnSelect expand="lg" bg="transparent" variant="light">
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav>
                            <Nav.Link data-nav-section="about" className="navLink" href="#about">About</Nav.Link>
                ...
                <Col>
                    ...
                    <div className="centerDiv">
                        ...
                        <span className="check">
                            <BsCheck style={{color: "#00D4FF", fontSize: "20px"}}/><span>Flexible prices</span> <br />
                            <BsCheck style={{color: "#00D4FF", fontSize: "20px"}}/><span>100% Original Essays</span><br />
                            <BsCheck style={{color: "#00D4FF", fontSize: "20px"}}/><span>On-time Delivery</span><br />
            ...
            <Modal.Body className="modaldiv" >
                ...
                <Row>
                    ...
                    <Col >
                        ...
                        <img className="contactSVG" src="./assets/images/tired.svg" alt="contactme" height="90%" width="100%" />
